...
function pos_satellite_relative_LGCV = ecef_ground2lgcv_vector_NLLS(pos_satellite_ECEF, pos_ground_ECEF)
    
    % convert groundstation geocentric LLH to ECEF
    pos_relative = pos_satellite_ECEF - pos_ground_ECEF;
    
    lambda = pos_ground_ECEF(1);      % latitude
    phi = pos_ground_ECEF(2);         % longitude
